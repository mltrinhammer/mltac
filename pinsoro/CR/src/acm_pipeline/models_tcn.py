...
class MultimodalTurnTCNRegressor(nn.Module):
    ...
    def __init__(
        ...
        if metadata_injection != "none" and backbone_model != "dyadic_shared":
            raise ValueError("metadata injection is currently supported only with backbone_model='dyadic_shared'.")
