...
The inference-only track is split into submitted-model artifacts, submitted-checkpoint feature ablations, partner ablations, and the CC soft-kappa sensitivity analysis.
