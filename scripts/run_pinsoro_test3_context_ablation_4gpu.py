"""Run Test 3 causal context ablations with matched optimizer-step budgets."""
...
DEFAULT_ROOT = PROJECT_ROOT / "model improvement" / "test 3 causal context ablation"
REQUIRED_OUTPUTS = (
    "config.json",
    "model_best.pt",
    "model_last.pt",
...
EXPERIMENTS = (
    Experiment(window=1200, stride=600, levels=6, epochs=30, min_epochs=12, patience=8),
    Experiment(window=1200, stride=300, levels=5, epochs=15, min_epochs=6, patience=4),
    Experiment(window=1800, stride=900, levels=5, epochs=45, min_epochs=18, patience=12),
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Test 3 causal context ablations sequentially.")
