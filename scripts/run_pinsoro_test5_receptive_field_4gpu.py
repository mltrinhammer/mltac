"""Run Test 5 receptive-field ablations and retain only the round winner."""
...
DEFAULT_ROOT = PROJECT_ROOT / "model improvement" / "test 5 receptive field ablation"
...
EXPERIMENTS = (
    Experiment(window=2400, stride=1200, levels=5, kernel=11, epochs=60, min_epochs=24, patience=16),
    Experiment(window=2400, stride=1200, levels=5, kernel=13, epochs=60, min_epochs=24, patience=16),
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Test 5 receptive-field ablations sequentially.")
